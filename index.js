...
var aud = new Audio('resources/ES_Juarez 1 - Niklas Ahlstrom.mp3');
aud.volume = 0;
aud.loop = true;
...
window.onload = () => {
    splash.style.backgroundImage = "url('resources/welcome_screen.png')";
    ...
    heart.style.backgroundImage = "url('resources/heart.png')";
